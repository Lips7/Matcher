...
public class TestMatcherJava {
    ...
    public void testTextProcessVariantNorm() {
        String result = SimpleMatcher.textProcess(
            ProcessType.VARIANT_NORM.getValue(),
            "A B 測試 Ａ １"
        );
    ...
    public void testProcessTypeAnd() {
        int result = ProcessType.and(
            ProcessType.DELETE_NORMALIZE,
            ProcessType.DELETE
        );
